...
export const ConflictIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const JournalIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v11.494m-5.253-11.494v11.494L12 6.253zm0 0h10.5m-10.5 0v11.494m0-11.494L6.747 3.75m5.253 2.503l5.253-2.503m-10.5 11.494L6.747 20.25m5.253-2.503l5.253 2.503M3 6.253v11.494c0 1.033.843 1.876 1.875 1.876h14.25c1.032 0 1.875-.843 1.875-1.876V6.253c0-1.033-.843-1.876-1.875-1.876H4.875C3.843 4.377 3 5.22 3 6.253z" />
  </svg>
);

export const LibraryIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v11.494M4.75 8.755l7.5 4.286 7.5-4.286M3 10.012A2 2 0 014.253 8.5h15.494A2 2 0 0121 10.012v4.976a2 2 0 01-1.253 1.814l-7.5 4.286a2 2 0 01-1.494 0l-7.5-4.286A2 2 0 013 14.988v-4.976z" />
  </svg>
);
